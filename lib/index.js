...
export function canonicalize({pdfBytes, fields} = {}) {
  ...
  //   - no discriminator, issuance date (DCF, DBD)
...
export async function hashCanonicalized({pdfBytes, fields} = {}) {
  const canonicalizedBytes = canonicalize({pdfBytes, fields});
